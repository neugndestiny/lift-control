...
public class liftcontrolTest {
    ...
    @Test
    public void moveFromGPlusOneToG() {
        String expectedResult = "down";
        String actualResult = liftcontrol.moveDirection("G+1","G");
        assertEquals(expectedResult, actualResult);
    }

    @Test
    public void moveFromTopToG() {
        String expectedResult = "down";
        String actualResult = liftcontrol.moveDirection("TOP","G");
        assertEquals(expectedResult, actualResult);
    }

    @Test
    public void moveFromTopToGPlusOne() {
        String expectedResult = "down";
        String actualResult = liftcontrol.moveDirection("TOP","G+1");
        assertEquals(expectedResult, actualResult);
    }

    @Test
    public void moveFromTopToTopMinusOne() {
        String expectedResult = "down";
        String actualResult = liftcontrol.moveDirection("TOP","TOP-1");
        assertEquals(expectedResult, actualResult);
    }
}